      ...
      this.el.addEventListener('markerFound', () => {
        ...
        fetch("https://kdmg.dii.univpm.it/iot/mobile/ar/example/query.php?sid=2")
          ...
          .then((data) => {
            ...
            document.getElementById("myDevice2").innerHTML = id_device;
            document.getElementById("myDeviceType2").innerHTML = type_device;          
            document.getElementById("myRoomA2").innerHTML = room_device;
